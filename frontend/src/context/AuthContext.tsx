...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Fill in EXPO_PUBLIC_GOOGLE_*_CLIENT_ID in frontend/.env from Google Cloud Console
  const [request, response, promptAsync] = Google.useAuthRequest({
    ...
    redirectUri: makeRedirectUri({ native: "com.violetseedlabs.trace:/oauth2redirect/google" }),
  });
